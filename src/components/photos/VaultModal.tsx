...
interface VaultModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSave: (entry: Omit<PhotoVaultEntry, 'id' | 'createdAt' | 'updatedAt'>) => Promise<void>;
    existingEntry?: PhotoVaultEntry | null;
}

const PROVIDERS: StorageProvider[] = ['Google Drive', 'OneDrive', 'Local NAS', 'Other'];

const emptyEntry: Omit<PhotoVaultEntry, 'id' | 'createdAt' | 'updatedAt'> = {
    title: '',
    projectId: '',
    projectName: '',
    clientId: '',
        ...
        <div className="modal-overlay">
            <div className="modal-content animate-fade-in" style={{ maxWidth: '600px' }}>
                <div className="modal-header">
                    <h2 className="modal-title">{existingEntry ? 'Edit Vault Entry' : 'Add to Photo Vault'}</h2>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column' }}>
                    <div className="modal-body" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
                        ...
                        <div className="form-group">
                            ...
                            <input required className="form-input" placeholder="e.g. Wedding Reception Highlights" value={formData.title} onChange={e => setFormData({ ...formData, title: e.target.value })} />
                        </div>
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group">
                                <label className="form-label">Estimated Photo Count</label>
                                <input type="number" min="0" className="form-input" value={formData.photoCount} onChange={e => setFormData({ ...formData, photoCount: parseInt(e.target.value) || 0 })} />
                            </div>
                        </div>

                        <div className="form-row">
                            <div className="form-group">
                                <label className="form-label">Lead Photographer Name</label>
                                <input className="form-input" value={formData.photographerName} onChange={e => setFormData({ ...formData, photographerName: e.target.value })} />
                            </div>
                            <div className="form-group">
